...
class SignupUserDtoToCredentialMapperImplTest {

    @Mock lateinit var signupUserDto: SignupUserDto

    lateinit var mapper: SignupUserDtoToCredentialMapper
    ...
    fun setUp() {
        ...
        _when(signupUserDto.password).thenReturn(password)


        mapper = SignupUserDtoToCredentialMapperImpl()
    }
    ...
    fun `when map with password null then trows NullPropertyException`(){
        ...
        _when(signupUserDto.password).thenReturn(null)
    ...
    fun `test map`(){
        ...
        assertThat(mapped.password, equalTo(signupUserDto.password))
    }
