...
class SignupUserDtoToUserMapperImpl : SignupUserDtoToUserMapper {

    override fun map(dto: SignupUserDto): User {
        return User(
                name = dto.name?.let { it } ?: throw NullPropertyException("Name must no be null"),
